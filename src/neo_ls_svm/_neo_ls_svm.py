...
class NeoLSSVM(BaseEstimator):
    ...
    def _optimize_β̂_γ(
        ...
        if C_is_diagonal:
            ...
            λ, Q = eigh(a=A, b=C)
            CQ_lu = lu_factor(C @ Q)
        # Compute the optimal parameters β̂ = Q(γI + Λ)⁻¹Q⁻¹C⁻¹φ(X)'SSy as a function of y. We can
        ...
        # Evaluate the unweighted leave-one-out residuals for a set of ys with two matrix-matrix
    ...
    def _optimize_α̂_γ(  # noqa: PLR0913
        ...
        # Compute the optimal parameters â = Q(γI + Λ)⁻¹Q⁻¹D⁻¹ [y; 0] as a function of y. We can
